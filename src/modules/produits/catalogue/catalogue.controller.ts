...
import { multerOptions } from 'src/helpers/file-upload-validate/file-upload-validate';

const crud = ApiConstants.crud('catalog');
const deleteMore = ApiConstants.crud(
  'The information required to delete an image from the catalogue',
);

@ApiTags('Gestion catalogue')
