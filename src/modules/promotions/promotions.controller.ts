...
const crud = ApiHelperConstants.crud('promotion');
const itemByPromotion = ApiHelperConstants.crud('item', 'promotion');
...
export class PromotionsController {
  ...
  @Get('/article')
  @ApiOperation({ summary: itemByPromotion.findAll.summaryListAll })
  @ApiResponse({
    status: 200,
