...
class PageDto {
    ...
    data;
    meta;
    constructor(data, meta, statusCode = 200, message = 'Operation successful') {
...
], PageDto.prototype, "statusCode", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Operation successful', required: false }),
    __metadata("design:type", String)
], PageDto.prototype, "message", void 0);
__decorate([
