...
var ItemForSaleService_1;
var _a, _b;
Object.defineProperty(exports, "__esModule", { value: true });
exports.ItemForSaleService = void 0;
...
let ItemForSaleService = ItemForSaleService_1 = class ItemForSaleService {
    itemModel;
    tvaModel;
    tarifModel;
    accModel;
    pipelineService;
    responseI18nService;
    logger = new common_1.Logger(ItemForSaleService_1.name);
    ipAddress = (0, app_helper_service_1.getServerIp)();
    port = process.env.PORT;
    baseUrl = `http://${this.ipAddress}:${this.port}/images/`;
    constructor(itemModel, tvaModel, tarifModel, accModel, pipelineService, responseI18nService) {
    ...
    async itemsTemplate(filterDto) {
        try {
            ...
            const tarificationFilter = tarificationId
                ? new mongoose_2.default.Types.ObjectId(tarificationId)
                : null;
            const storeFilter = categoryId
                ? new mongoose_2.default.Types.ObjectId(storeId)
                : null;
            const filter = {};
            if (filterDto?.itemId) {
                filter._id = new mongoose_2.default.Types.ObjectId(filterDto.itemId);
            }
            if (filterDto?.categoryId) {
                filter.categorie = new mongoose_2.default.Types.ObjectId(filterDto.categoryId);
            }
            if (filterDto?.visible !== undefined) {
                filter.visibleCaisse = filterDto.visible;
            }
            else {
                filter.visibleCaisse = true;
            }
...
exports.ItemForSaleService = ItemForSaleService;
exports.ItemForSaleService = ItemForSaleService = ItemForSaleService_1 = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, mongoose_1.InjectModel)(article_entity_1.Article.name)),
    __param(1, (0, mongoose_1.InjectModel)(tva_entity_1.Tva.name)),
    __param(2, (0, mongoose_1.InjectModel)(tarrification_entity_1.Tarrification.name)),
    __param(3, (0, mongoose_1.InjectModel)(accompagnement_entity_1.Accompagnement.name)),
    __metadata("design:paramtypes", [mongoose_2.Model,
        mongoose_2.Model,
        mongoose_2.Model,
        mongoose_2.Model, typeof (_a = typeof pipeline_1.PipelineService !== "undefined" && pipeline_1.PipelineService) === "function" ? _a : Object, typeof (_b = typeof response_i18n_service_1.ResponseI18nService !== "undefined" && response_i18n_service_1.ResponseI18nService) === "function" ? _b : Object])
], ItemForSaleService);
//# sourceMappingURL=other-sale.service.js.map